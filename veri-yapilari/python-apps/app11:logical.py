...
#    b-) Fİnalden 70 alındığında ortalama önemli olmasın
...
print(f"öğrenci not ortalaması: {ortalama} ve geçme durumu: {ortalama >= 50}")
...
print(f"{ad} kilo indeksin: {kiloIndeks} ve değerlendirmen zayıf: {zayif}")
print(f"{ad} kilo indeksin: {kiloIndeks} ve değerlendirmen normal: {normal}")
print(f"{ad} kilo indeksin: {kiloIndeks} ve değerlendirmen kilolu: {kilolu}")
print(f"{ad} kilo indeksin: {kiloIndeks} ve değerlendirmen obez: {obez}")